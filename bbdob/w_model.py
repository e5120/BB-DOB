...
class WModel(ObjectiveBase):
    ...
    def neutrality_layer(self, c):
        ...
        -------
        numpy.ndarray
            A vector (solution) after applying to neutrality.
        """
    ...
    def epistasis_layer(self, c):
        ...
        -------
        numpy.ndarray
            A vector (solution) after applying to epistasis.
        """
        dim = c.shape[1]
        if dim % self.v != 0:
            remain = c[:, -(dim % self.v):]
    ...
    def multi_objective_layer(self, c):
        ...
        -------
        numpy.ndarray
            Vectors (solutions) after applying to multi objectivity.
        """
    ...
    def evaluation_layer(self, c):
        ...
        -------
        numpy.ndarray
            The evaluation values corresponding to the vectors (solutions).
        """
    ...
    def ruggedness_and_deceptiveness_layer(self, c):
        ...
        -------
        numpy.ndarray
            The evaluation values after applying to ruggedness and deceptiveness.
        """
        return self.perm[c]
